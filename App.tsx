...
const App: React.FC = () => {
  const { transactions, addTransaction, deleteTransaction, stats, settings, updateSettings, toasts, removeToast, exportToCSV, backupData, isDataLoaded } = useTransactions();
